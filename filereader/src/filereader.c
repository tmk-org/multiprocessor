...
int main (int argc, char **argv) {
    ...
    filelist = get_filelist(in_path, NULL); // NULL or any extension, for example "tiff"
    ...
    fprintf(stdout, "Read files one by one and work with it\n");
    int i, rc = -1, cnt = 0;
    char *path = NULL, *base = NULL, *ext =NULL, *src=NULL, *dst = NULL;
    char *image = NULL; //image is any binary data
    ...
    for (i = start_frame; i < end_frame; i++) {
        ...
        dst = generate_filename(out_path, base, ".r.bmp");
